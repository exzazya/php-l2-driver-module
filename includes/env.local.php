...
if (!defined('MAIL_FROM'))      define('MAIL_FROM', 'franklinkencarranza@gmail.com');
if (!defined('MAIL_FROM_NAME')) define('MAIL_FROM_NAME', 'Jetlouge Travels');

if (!defined('SMTP_HOST'))      define('SMTP_HOST', 'smtp.gmail.com');
if (!defined('SMTP_USERNAME'))  define('SMTP_USERNAME', 'franklinkencarranza@gmail.com');
// Google app passwords are 16 chars WITHOUT spaces
if (!defined('SMTP_PASSWORD'))  define('SMTP_PASSWORD', 'zfdpegpysxvmrjpn');
